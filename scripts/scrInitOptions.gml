///scrInitOptions()
//Game options
global.gameName = "I Wanna Relax With Needle"; //Name that will be displayed on the game window
...
global.totalItems = 0; //The number of items your game may have
global.totalBossItems = 0; //The number of boss items your game may have
...
//Misc. options
global.startRoom = r1; //The room where the game will start
...
global.deathMusic = false; //If the death music should play when dying
global.noPause = false; //If this is set to true you won't be able to pause the game
global.totalPauseDelay = 15; //Total of frames that should pass before the game lets you pause again
